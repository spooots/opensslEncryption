...
INFO "SENDER and RECEIVER have to exchange their public keys in a safe way"
...
INFO "   Encrypt AES Key with RSA Public Key"
openssl rsautl -encrypt -inkey publicR.pem -pubin -in keyfile -out keyfile.enc || exit $?

INFO "   Generate a signature for the message.txt"
...
INFO ""
INFO "RECEIVER:"
INFO "   Decrypt AES key with RSA private key"
...
INFO "   Verify the signature for the recieved file.txt and the signature.txt"
